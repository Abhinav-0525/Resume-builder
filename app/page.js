  ...
  return (
    <div style={{display:"flex", justifyContent:"center", flexDirection:"column"}}>
      ...
      <div className="flex justify-center items-center mt-5 gap-10">
          <Card className="w-60">
            <CardContent>
              <Image src="/template-1.png" width={200} height={200} alt="img"></Image>
            </CardContent>
            <CardFooter className="grid justify-items-end">
              <Button onClick={()=>handleClick("template-1")}>
                Try out!
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="w-60">
            ...
            <CardFooter className="grid justify-items-end">
              <Button onClick={()=>handleClick("template-2")}>
                Try out!
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="w-60">
            ...
            <CardFooter className="grid justify-items-end">
              <Button onClick={()=>handleClick("template-3")}>
                Try out!
              </Button>
            </CardFooter>
          </Card>
